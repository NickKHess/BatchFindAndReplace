...
class FindAndReplace():
    ...
    def execute(self):
        ...
        files = [file for file in listdir(self.directory) if isfile(join(self.directory, file)) and (self.extension in file) and (not '-temp' + self.extension in file)]
        ...
        for file in files:
            ...
            try:
                ...
                file_path = join(self.directory, file)
              
                # Open the file
                open_file = open(file_path, mode='r')
                
                temp_path = join(self.directory, f'{no_ext}-temp{self.extension}')
